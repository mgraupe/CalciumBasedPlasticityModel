...
irrPairsDTS = np.load(dir0+'irregularSpikePairs_vs_deltaT_differentFreqs_STDstoch_%s.npy' % parameterSet)
regPairsDT = np.load(dir0+'regularSpikePairs_vs_deltaT_differentFreqs_STDdet_%s.npy' % parameterSet)

irrPairsP = np.load(dir0+'irregularSpikePairs_vs_deltaT_differentPs_STDdet_%s.npy' % parameterSet)
...
ax81.plot(irrPairsDTS[:,0]*1000.,irrPairsDTS[:,15]/w0,lw=2,c='magenta')
...
irrPairsFreqS = np.load(dir0+'irregularSpikePairs_vs_rate_differentDeltaTs_STDstoch_%s.npy' % parameterSet)
