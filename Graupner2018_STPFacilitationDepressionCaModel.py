...
par = 'tmmfacilitationDepressionJesperCaModel'
...
for i in range(len(freq)):
    ...
    (alphaD, alphaP) = tat.spikePairFrequencyTMM(0.01 - synChange.D, freq[i], synChange.Npairs, synChange.U, synChange.tauFac, synChange.tauDep)
...
for i in range(len(deltaTs)):
    (alphaD, alphaP) = tat.spikePairFrequencyTMM(deltaTs[i] - synChange.D, 0.1 , synChange.Npairs, synChange.U, synChange.tauFac, synChange.tauDep)
    synChange.changeInSynapticStrength(synChange.Npresentations, w0, alphaD, alphaP)
