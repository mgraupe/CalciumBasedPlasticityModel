...
#################################################################################################
print 'irregular pairs : synaptic change vs Delta T for frequencies p\'s, STD stochastic'
...
for i in range(len(deltaT)):
    ...
    #n = 1
    #args = (deltaT[i],frequencies[n], frequencies[n], ppp)
    #runIrregularPairSTPStochasticSimulations(args)
    #pdb.set_trace()
...
# synaptic change vs Delta T for irregular Pairs
##################################################################################################
print 'irregular pairs : synaptic change vs Delta T for different p\'s, STD stochastic'
...
##################################################################################################
print 'irregular pairs : synaptic change vs rate for different deltaT\'s and p\'s, STD stochastic'
